...
const BLOOD_THIRST = {
  ...
  reaperArc: {
    id: 'reaperArc',
    name: "Reaper's Arc",
    description: 'Every 10th hit: 360° sweep. Deals 1/2/3/4/5% max HP, costs 0.5/1/1.5/2/2.5% HP',
    tree: 'bloodThirst',
    tier: 4,
    requires: 'killRush',
    maxRank: MAX_RANK,
    hitInterval: [10, 10, 10, 10, 10],
...
const SAPPER = {
  ...
  decoy: {
    ...
    cloneDamagePct: [0.40, 0.40, 0.40, 0.40, 0.40],
  ...
  decoyBarrage: {
    ...
    barrageDmgPct: [0.40, 0.40, 0.40, 0.40, 0.40],
    launchSpeed: 5,
  },
  volatileDecoy: {
    id: 'volatileDecoy',
    ...
    maxRank: MAX_RANK,
    explosionDmgPct: [0.024, 0.048, 0.072, 0.096, 0.12],
    explosionRadius: [60, 70, 80, 100, 120],
  },
  singularity: {
    id: 'singularity',
    name: 'Singularity',
    description: '50% chance decoy explosion becomes a black hole: {value}s pull, 1.5% HP/s DoT, +3/6/9% detonation',
    tree: 'sapper',
    tier: 5,
