...
const FIREPOWER = {
  ...
  dualCannon: {
    id: 'dualCannon',
    name: 'Homing Cannon',
    description: 'Every 10/8/6th shot: homing bullet targeting lowest HP enemy, 400% dmg',
    tree: 'firepower',
    tier: 5,
    requires: 'multiShot',
    maxRank: MAX_RANK_CAPSTONE,
    fireFrequency: [10, 8, 6],
    homingDamageMultiplier: 4.0,
    homingStrength: 0.15,
  },
};
...
const BLOOD_THIRST = {
  ...
  reaperArc: {
    id: 'reaperArc',
    name: "Reaper's Arc",
    description: 'Every 15th hit: 360° sweep. Deals 0.75-3.75% max HP, costs 0.375-1.875% HP',
    tree: 'bloodThirst',
    tier: 4,
    requires: 'killRush',
    maxRank: MAX_RANK,
    ...
    hpCost: [0.00375, 0.0075, 0.01125, 0.015, 0.01875],
    sweepRange: 200,
