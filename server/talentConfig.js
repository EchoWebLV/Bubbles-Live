...
const BLOOD_THIRST = {
  ...
  reaperArc: {
    id: 'reaperArc',
    name: "Reaper's Arc",
    description: 'Every 12th hit: 360° sweep. Deals 0.5-2.5% max HP, costs 0.5-2.5% HP',
    tree: 'bloodThirst',
    tier: 4,
    requires: 'killRush',
    maxRank: MAX_RANK,
    hitInterval: [10, 10, 10, 10, 10],
    sweepDamagePct: [0.005, 0.01, 0.015, 0.02, 0.025],
    hpCost: [0.0025, 0.005, 0.0075, 0.01, 0.0125],
    sweepRange: 200,
  ...
  berserker: {
    id: 'berserker',
    name: 'Berserker',
    description: 'Below 50% HP: +{value}% atk speed & dmg. R3: +3.5 HP/s regen',
    tree: 'bloodThirst',
    tier: 5,
    requires: 'reaperArc',
    maxRank: MAX_RANK_CAPSTONE,
