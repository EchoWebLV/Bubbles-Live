...
const SAPPER = {
  ...
  volatileDecoy: {
    ...
    maxRank: MAX_RANK,
    explosionDmgPct: [0.02, 0.04, 0.06, 0.08, 0.10],
    explosionRadius: [60, 70, 80, 100, 120],
  },
  singularity: {
    id: 'singularity',
    name: 'Singularity',
    description: '50% chance decoy explosion becomes a black hole: {value}s pull, 2.25% HP/s DoT, +4/8/12% detonation',
    tree: 'sapper',
    tier: 5,
    requires: 'volatileDecoy',
    maxRank: MAX_RANK_CAPSTONE,
    procChance: 0.50,
    pullDurationMs: [1500, 3000, 4500],
    pullRadius: [120, 160, 200],
    dotPerSecondPct: 0.0225,
    detonationBonus: [0.04, 0.08, 0.12],
    maxPulled: [1, 2, 3],
    pullStrength: 0.03,
  },
